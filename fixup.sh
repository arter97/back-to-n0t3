...
ln -s $SYSTEMDIR/lib64/libaed.so $SYSTEMDIR/app/AdvSoundDetector2015/lib/arm64/libaed.so
ln -s $SYSTEMDIR/lib64/libdefcontainer_jni.so $SYSTEMDIR/priv-app/DefaultContainerService/lib/arm64/libdefcontainer_jni.so
ln -s $SYSTEMDIR/lib64/libfdb.so $SYSTEMDIR/app/AdvSoundDetector2015/lib/arm64/libfdb.so
ln -s $SYSTEMDIR/lib64/libjni_pacprocessor.so $SYSTEMDIR/app/PacProcessor/lib/arm64/libjni_pacprocessor.so
ln -s $SYSTEMDIR/lib64/libload-strings.so $SYSTEMDIR/priv-app/SHealth4_3/lib/arm64/libload-strings.so
ln -s $SYSTEMDIR/lib64/libnfc_nci_jni.so $SYSTEMDIR/app/NfcNci/lib/arm64/libnfc_nci_jni.so
ln -s $SYSTEMDIR/lib64/libPedometer.so $SYSTEMDIR/priv-app/SHealth4_3/lib/arm64/libPedometer.so
ln -s $SYSTEMDIR/lib64/libPlatformStrings.so $SYSTEMDIR/priv-app/HealthService/lib/arm64/libPlatformStrings.so
ln -s $SYSTEMDIR/lib64/libPlatformStrings.so $SYSTEMDIR/priv-app/SHealth4_3/lib/arm64/libPlatformStrings.so
ln -s $SYSTEMDIR/lib64/libprintspooler_jni_mr1.so $SYSTEMDIR/app/SPrintSpoolerLMR1/lib/arm64/libprintspooler_jni_mr1.so
ln -s $SYSTEMDIR/lib64/libSamsungBCPP.so $SYSTEMDIR/app/AdvSoundDetector2015/lib/arm64/libSamsungBCPP.so
ln -s $SYSTEMDIR/lib64/libsecsqlite.so $SYSTEMDIR/priv-app/SHealth4_3/lib/arm64/libsecsqlite.so
ln -s $SYSTEMDIR/lib64/libSensorNativeProtocol.so $SYSTEMDIR/priv-app/SHealth4_3/lib/arm64/libSensorNativeProtocol.so
ln -s $SYSTEMDIR/lib64/lib_stressanalyzer_v03_jni.so $SYSTEMDIR/priv-app/SHealth4_3/lib/arm64/lib_stressanalyzer_v03_jni.so
ln -s $SYSTEMDIR/lib/libapa_jni.so $SYSTEMDIR/app/SapaMonitor/lib/arm/libapa_jni.so
ln -s $SYSTEMDIR/lib/libasf_fileshareserver.so $SYSTEMDIR/app/AllshareFileShareServer/lib/arm/libasf_fileshareserver.so
ln -s $SYSTEMDIR/lib/libasf_fileshare.so $SYSTEMDIR/app/AllshareFileShare/lib/arm/libasf_fileshare.so
ln -s $SYSTEMDIR/lib/libasf_mediashare.so $SYSTEMDIR/app/AllshareMediaShare/lib/arm/libasf_mediashare.so
ln -s $SYSTEMDIR/lib/libatomcore.so $SYSTEMDIR/priv-app/OutOfFocusViewer_WQHD_K/lib/arm/libatomcore.so
ln -s $SYSTEMDIR/lib/libatomjpeg.so $SYSTEMDIR/priv-app/OutOfFocusViewer_WQHD_K/lib/arm/libatomjpeg.so
ln -s $SYSTEMDIR/lib/libbluetooth_jni.so $SYSTEMDIR/app/Bluetooth/lib/arm/libbluetooth_jni.so
ln -s $SYSTEMDIR/lib/libcmph.so $SYSTEMDIR/app/SecDict2Noble/lib/arm/libcmph.so
ln -s $SYSTEMDIR/lib/libcommonpawrapper.so $SYSTEMDIR/app/RootPA/lib/arm/libcommonpawrapper.so
ln -s $SYSTEMDIR/lib/libCreateSceneMap.so $SYSTEMDIR/priv-app/VirtualTourViewer_WQHD_lightTheme/lib/arm/libCreateSceneMap.so
ln -s $SYSTEMDIR/lib/libDioDict3EngineNativeFrame.so $SYSTEMDIR/app/SecDict2Noble/lib/arm/libDioDict3EngineNativeFrame.so
ln -s $SYSTEMDIR/lib/libdioiculemma2.so $SYSTEMDIR/app/SecDict2Noble/lib/arm/libdioiculemma2.so
ln -s $SYSTEMDIR/lib/libhuffman.so $SYSTEMDIR/app/SecDict2Noble/lib/arm/libhuffman.so
ln -s $SYSTEMDIR/lib/libjma2.so $SYSTEMDIR/app/SecDict2Noble/lib/arm/libjma2.so
ln -s $SYSTEMDIR/lib/libmorpho_panorama_wa_for_viewer.so $SYSTEMDIR/app/Panorama360Viewer_Zero/lib/arm/libmorpho_panorama_wa_for_viewer.so
ln -s $SYSTEMDIR/lib/libmorpho_sensor_fusion_for_viewer.so $SYSTEMDIR/app/Panorama360Viewer_Zero/lib/arm/libmorpho_sensor_fusion_for_viewer.so
ln -s $SYSTEMDIR/lib/libnltk2.so $SYSTEMDIR/app/SecDict2Noble/lib/arm/libnltk2.so
ln -s $SYSTEMDIR/lib/libqjpeg_secvision.so $SYSTEMDIR/priv-app/VirtualTourViewer_WQHD_lightTheme/lib/arm/libqjpeg_secvision.so
ln -s $SYSTEMDIR/lib/libSamsungVoiceEngine.so $SYSTEMDIR/priv-app/SVF/lib/arm/libSamsungVoiceEngine.so
ln -s $SYSTEMDIR/lib/libSamsungVoiceEngine.so $SYSTEMDIR/priv-app/S-Voice_Android_phone/lib/arm/libSamsungVoiceEngine.so
ln -s $SYSTEMDIR/lib/libsecipx.so $SYSTEMDIR/priv-app/OutOfFocusViewer_WQHD_K/lib/arm/libsecipx.so
ln -s $SYSTEMDIR/lib/libSensoryUDTSIDEngine.so $SYSTEMDIR/priv-app/S-Voice_Android_phone/lib/arm/libSensoryUDTSIDEngine.so
ln -s $SYSTEMDIR/lib/libSensoryWakeUpEngine.so $SYSTEMDIR/priv-app/S-Voice_Android_phone/lib/arm/libSensoryWakeUpEngine.so
ln -s $SYSTEMDIR/lib/libSRIB_FocusShot.so $SYSTEMDIR/priv-app/OutOfFocusViewer_WQHD_K/lib/arm/libSRIB_FocusShot.so
ln -s $SYSTEMDIR/lib/libstlport_shared.so $SYSTEMDIR/app/SecDict2Noble/lib/arm/libstlport_shared.so
ln -s $SYSTEMDIR/lib/libsvoxtts.so $SYSTEMDIR/priv-app/S-Voice_Android_phone/lib/arm/libsvoxtts.so
ln -s $SYSTEMDIR/lib/libTui.so $SYSTEMDIR/app/TuiService/lib/arm/libTui.so
